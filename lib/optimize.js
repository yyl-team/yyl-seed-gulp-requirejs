...
function loadModules() {
  extFs = require('yyl-fs');
  chalk = require('chalk');

  gulp = require('gulp');
  util = require('yyl-util');
  frp = require('yyl-file-replacer');
  ...
  SeedResponse = require('yyl-seed-response');
  inlinesource = require('yyl-inlinesource');
