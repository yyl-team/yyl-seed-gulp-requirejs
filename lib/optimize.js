...
const wOpzer = function (op) {
  ...
  opzer.o = function (iEnv) {
    iEnv.isCommit = true
    return opzer.all(iEnv)
  }

  opzer.w = function (iEnv) {
    return opzer.watch(iEnv)
  }

  opzer.d = function (iEnv) {
    iEnv.proxy = true
    return opzer.watch(iEnv)
  }

  opzer.r = function (iEnv) {
    iEnv.proxy = true
    iEnv.remote = true
    return opzer.watch(iEnv)
  }
